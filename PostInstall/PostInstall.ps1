...
function set-time {
  ...
  Set-ItemProperty -Path HKLM:\SYSTEM\CurrentControlSet\Services\W32Time\Parameters -Name Get-Content -Value NTP | Out-Null
...
function Server2019Controller {
  ...
  if ((gwmi win32_operatingsystem | ForEach-Object caption) -like '*Windows Server 2019*') {
